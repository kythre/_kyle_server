...
advjl_groups = {
	...
	-- Group: Superadmin
	{
		...
		playsound="", 
		leftsound="", 
		messageformat="#FFFFFF[#25DB00JOIN:#FFFFFF] !playername! joined our server from #FFFFFF[#25DB00!country!!#FFFFFF]", 
		messageformatdc="#FFFFFF[#DB0000LEFT:#FFFFFF] !playername![!steamid!] has left.", 
		resolvecountry=true
	},
	...
	-- Default Group (everything expect these groups above)
	{
		...
		playsound="", 
		leftsound="",
		messageformat="[$!playername! #FFFFFFjoined the server from: #00FF00!country!", 
		messageformatdc="[#00FF00!playername!#FFFFFF (#FFFFFF!steamid!#FFFFFF) has left.", 
		resolvecountry=true
